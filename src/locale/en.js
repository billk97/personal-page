export default {
    ...
    sortDirection: ["I currently work as a Backend Software engineer", " developing new features while " +
        ...
        "of information security, clean coding, code architecture, DevOps, secure application development, and " +
        "lots of other relevant domains. I'm eager to learn new technologies and further develop my knowledge."],
    mpassWorkDescription: "I Develop and maintaining restful API  for the company's products. Actively take part in code " +
